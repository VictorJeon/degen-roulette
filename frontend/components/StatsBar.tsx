  ...
  return (
    <div className="grid grid-cols-4 max-[500px]:grid-cols-2 gap-1.5 w-full mb-2.5">
      <div className="flex flex-col items-center gap-0.5 bg-bg-surface border border-border-default rounded-lg p-2 text-center">
        <span className="font-pixel text-sm max-md:text-xs text-gray-200 tracking-wide">BET</span>
      ...
      <div className="flex flex-col items-center gap-0.5 bg-bg-surface border border-border-default rounded-lg p-2 text-center">
        ...
        <span className="font-pixel text-sm max-md:text-xs text-accent">{currentMultiplier.toFixed(2)}x</span>
      </div>
      <div className="flex flex-col items-center gap-0.5 bg-bg-surface border border-border-default rounded-lg p-2 text-center">
        <span className="font-pixel text-sm max-md:text-xs text-gray-200 tracking-wide">POTENTIAL</span>
      ...
      <div className="flex flex-col items-center gap-0.5 bg-bg-surface border border-danger/30 rounded-lg p-2 text-center">
        <span className="font-pixel text-sm max-md:text-xs text-gray-200 tracking-wide">DEATH</span>
        <span className="font-pixel text-sm max-md:text-xs text-danger">{deathOdds}%</span>
      </div>
    </div>
  );
}
