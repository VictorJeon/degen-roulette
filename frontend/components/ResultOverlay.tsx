...
export function ResultOverlay({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/94 z-[1000] animate-[fadeIn_0.35s_ease-out]" role="dialog" aria-modal="true" aria-label="Game result">
      <div
      ...
      >
        ...
        {onShowFair && (
          <button
            ...
            onClick={onShowFair}
            aria-label="View provably fair proof"
